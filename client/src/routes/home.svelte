<div class="container-scroller">
			...
			>
				<div class="ps-lg-3">
					<div class="d-flex align-items-center justify-content-between">
						...
						<a
							href="https://www.bootstrapdash.com/product/star-admin-pro/?utm_source=navbar&utm_medium=productdemo&utm_campaign=getpro"
							target="_blank"
				...
				<div class="d-flex align-items-center justify-content-between">
					<a href="https://www.bootstrapdash.com/product/star-admin-pro/"
						><i class="ti-home me-3 text-white" /></a
					>
					<button id="bannerClose" class="btn border-0 p-0">
						<i class="ti-close text-white" />
					</button>
				</div>
			</div>
		</div>
				...
				<li class="nav-item dropdown d-none d-lg-block user-dropdown">
					...
					>
						...
						<a class="dropdown-item"
							><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2" /> My Profile
							<span class="badge badge-pill badge-danger">1</span></a
						>
						<a class="dropdown-item"
							><i class="dropdown-item-icon mdi mdi-message-text-outline text-primary me-2" /> Messages</a
						>
						<a class="dropdown-item"
							><i class="dropdown-item-icon mdi mdi-calendar-check-outline text-primary me-2" /> Activity</a
						>
						<a class="dropdown-item"
							><i class="dropdown-item-icon mdi mdi-help-circle-outline text-primary me-2" /> FAQ</a
						>
						<a class="dropdown-item"
							><i class="dropdown-item-icon mdi mdi-power text-primary me-2" />Sign Out</a
						>
					</div>
				</li>
			</ul>
	...
	<div class="container-fluid page-body-wrapper">
		...
		<div class="theme-setting-wrapper">
			<div id="settings-trigger"><i class="ti-settings" /></div>
			<div id="theme-settings" class="settings-panel">
				<i class="settings-close ti-close" />
				...
				<div class="color-themes mx-0 px-4">
					<a href="#" class="color-theme default" />
					<a href="#" class="color-theme dark" />
					<a href="#" class="color-theme brown" />
				</div>
			</div>
		</div>
				...
				>
					...
					<div class="events pt-4 px-3">
						<div class="wrapper d-flex mb-2">
							<i class="ti-control-record text-primary me-2" />
				...
				>
					...
					<ul class="chat-list">
						<li class="list active">
							<div class="profile">
								<img src="../../images/faces/face1.jpg" alt="image" /><span class="online" />
							</div>
							<div class="info">
								<p>Thomas Douglas</p>
								<p>Available</p>
						...
						<li class="list">
							<div class="profile">
								<img src="../../images/faces/face2.jpg" alt="image" /><span class="offline" />
							</div>
							<div class="info">
						...
						<li class="list">
							<div class="profile">
								<img src="../../images/faces/face3.jpg" alt="image" /><span class="online" />
							</div>
							<div class="info">
								<p>Daniel Russell</p>
								<p>Available</p>
						...
						<li class="list">
							<div class="profile">
								<img src="../../images/faces/face4.jpg" alt="image" /><span class="offline" />
							</div>
							<div class="info">
						...
						<li class="list">
							<div class="profile">
								<img src="../../images/faces/face5.jpg" alt="image" /><span class="online" />
							</div>
							<div class="info">
						...
						<li class="list">
							<div class="profile">
								<img src="../../images/faces/face6.jpg" alt="image" /><span class="online" />
							</div>
							<div class="info">
								<p>Sarah Graves</p>
								<p>Available</p>
		...
		<nav class="sidebar sidebar-offcanvas" id="sidebar">
			<ul class="nav">
				<li class="nav-item">
					...
					<div class="collapse" id="dashboards">
						<ul class="nav flex-column sub-menu">
							...
							<li class="nav-item">
								<a class="nav-link" href="pages/dashboards/purple.html">Purple</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="pages/dashboards/purple-dark.html">Purple Dark</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="pages/dashboards/sales.html">Sale</a>
							</li>
							<li class="nav-item"><a class="nav-link" href="pages/dashboards/hr.html">HR</a></li>
						</ul>
					</div>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="pages/widgets/widgets.html">
						<i class="mdi mdi-book menu-icon" />
						<span class="menu-title">Widgets</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="pages/page-layouts/rtl.html">
						<i class="mdi mdi-cube-outline menu-icon" />
				...
				<li class="nav-item">
					...
					>
						<i class="menu-icon mdi mdi-arrow-down-drop-circle-outline" />
				...
				<li class="nav-item">
					...
					>
						<i class="menu-icon mdi mdi-code-braces" />
				...
				<li class="nav-item">
					<a class="nav-link" href="pages/ui-features/popups.html">
						<i class="menu-icon mdi mdi-alert-outline" />
						<span class="menu-title">Popups</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="pages/ui-features/notifications.html">
						<i class="menu-icon mdi mdi-bell-alert-outline" />
				...
				<li class="nav-item">
					<a
						...
						aria-controls="maps"
					>
						<i class="menu-icon mdi mdi-google-maps" />
				...
				<li class="nav-item">
					<a
						...
						aria-controls="error"
					>
						<i class="menu-icon mdi mdi-stop-circle-outline" />
				...
				<li class="nav-item">
					...
					>
						<i class="menu-icon mdi mdi-book-open" />
				...
				<li class="nav-item">
					...
					>
						<i class="menu-icon mdi mdi-cart-arrow-down" />
				...
				<li class="nav-item">
					<a class="nav-link" href="pages/apps/calendar.html">
						<i class="menu-icon mdi mdi-calendar" />
				...
				<li class="nav-item">
					<a class="nav-link" href="pages/apps/gallery.html">
						<i class="menu-icon mdi mdi-file-image-outline" />
				...
				<li class="nav-item">
					<a
						class="nav-link"
						href="https://bootstrapdash.com/demo/star-admin2-pro/docs/documentation.html"
					>
								...
								<div>
									<div class="btn-wrapper">
										<a href="#" class="btn btn-otline-dark align-items-center"
											><i class="icon-share" /> Share</a
										>
										<a href="#" class="btn btn-otline-dark"><i class="icon-printer" /> Print</a>
										<a href="#" class="btn btn-primary text-white me-0"
											><i class="icon-download" /> Export</a
										>
									</div>
								</div>
							</div>
											...
											>
												<div>
													...
													<p class="text-danger d-flex">
														<i class="mdi mdi-menu-down" /><span>-0.5%</span>
													</p>
												</div>
												<div>
													...
													<p class="text-success d-flex">
														<i class="mdi mdi-menu-up" /><span>+0.1%</span>
													</p>
												</div>
												<div>
													...
													<p class="text-danger d-flex">
														<i class="mdi mdi-menu-down" /><span>68.8</span>
													</p>
												</div>
												<div class="d-none d-md-block">
													...
													<p class="text-success d-flex">
														<i class="mdi mdi-menu-down" /><span>+0.8%</span>
													</p>
												</div>
												<div class="d-none d-md-block">
													<p class="statistics-title">New Sessions</p>
													...
													<div class="card card-rounded">
														<div class="card-body">
															...
															>
																...
																<div class="me-3"><div id="marketing-overview-legend" /></div>
															</div>
															...
															<div class="d-sm-flex justify-content-between align-items-start">
																...
																<div>
																	<button
																		...
																		type="button"
																		><i class="mdi mdi-account-plus" />Add new member</button
																	>
																</div>
															</div>
																...
																<div class="wrapper w-100">
																	<p class="mb-0">
																		<a href="#" class="fw-bold text-primary"
																			>Show all <i class="mdi mdi-arrow-right ms-2" /></a
																		>
																	</p>
																</div>
															</div>
															...
															<ul class="bullet-line-list">
																<li>
																	<div class="d-flex justify-content-between">
																		<div>
																			<span class="text-light-green">Ben Tossell</span> assign you a
																			task
																		</div>
																		<p>Just now</p>
																	</div>
																...
																<li>
																	<div class="d-flex justify-content-between">
																		<div>
																			<span class="text-light-green">Oliver Noah</span> assign you a
																			task
																		</div>
																		<p>1h</p>
																	</div>
																...
																<li>
																	<div class="d-flex justify-content-between">
																		<div>
																			<span class="text-light-green">Jack William</span> assign you a
																			task
																		</div>
																		<p>1h</p>
																	</div>
																...
																<li>
																	<div class="d-flex justify-content-between">
																		<div>
																			<span class="text-light-green">Leo Lucas</span> assign you a task
																		</div>
																		<p>1h</p>
																	</div>
																</li>
																<li>
																	<div class="d-flex justify-content-between">
																		<div>
																			<span class="text-light-green">Thomas Henry</span> assign you a
																			task
																		</div>
																		<p>1h</p>
																	</div>
