...
<nav class="mt-5 ">
			...
			<div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
				...
				<!-- <div class="hidden sm:block sm:ml-6">
					<div class="flex space-x-4">
						<a
							href="/dashboard"
							class="dashboard-text text-white px-3 py-2 rounded-md text-sm font-medium"
	...
	<div style="display: {mainMenu};" id="mobile-menu">
		<div class="px-2 pt-2 pb-3 space-y-1">
			...
			<a
				href="/dashboard"
				class="dashboard-text text-white block px-3 py-2 rounded-md text-base font-medium"
				aria-current="page">Dashboard</a
			>
			<a
				href="/chat"
